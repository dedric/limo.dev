			...
			<div class="content">
				<div class="container_12">
					...
					<div class="grid_5">
						<h3>Contact Info</h3>
						<div class="map">
							<div class="text1 color2">24-7</div>
							<p><span class="text7">We'll be glad to answer any questions you may have.</span></p>
							<address>
								<dl>
									<dt>DBH Limo<br>
										Charleston, SC
									</dt>
									<dd><span>Telephone:</span> 843.303.4761</dd>
									<dd>&nbsp;</dd>
									<dd>E-mail: <a href="mailto:info@dbhlimo.com" class="color1">info@dbhlimo.com</a></dd>
								</dl>
							</address>
						</div>
					</div>
					<div class="grid_6 prefix_1">
						<h3>Contact Form</h3>
						 <form action="formmail.php" method="POST" name="form1" onSubmit="VF_form1();return false;">
...
<div align="center"><input name="sendmail" type="hidden" id="sendmail" value="1" /> <input name="send" type="submit" value="Submit Request" /> <input type="reset" value="Clear the Form" name="reset" /></div>
